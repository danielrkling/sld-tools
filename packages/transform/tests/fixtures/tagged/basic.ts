...
const handler = () => {};
const myRef = (el: any) => {};
const Component = (props: any) => jsx`<div>Component</div>`;
const props = { id: "test" };
function jsx(strings: TemplateStringsArray, ...exprs: any[]) {}
export const blank = jsx``;
...
export const withBooleanAttributes = jsx`<button disabled>Hello</button>`;
...
export const withSpread = jsx`<div ...${props}>Hello</div>`;
...
export const selfClosingChild = jsx`<div><img /></div>`;
