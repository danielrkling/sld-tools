...
export const withBooleanAttributes = <button disabled>Hello</button>;
...
export const withSpread = <div {...props}>Hello</div>;
...
export const componentWithChild = <Component>Child</Component>;
export const selfClosingChild = <div><img /></div>;
